...
export const philippines: CultureEntry[] = [
  {
    id: "los-jeepneys-arte-popular-sobre-ruedas",
    order: 1,
    placeholderEmoji: "🚙",
    accentColor: "#0038A8",
    imageUrl: null,
    translations: {
      es: {
        title: "Los jeeps militares que se volvieron arte popular",
        subtitle: "Los jeepneys, arte popular sobre ruedas",
        imageAlt: "Caricatura de un jeep alargado y colorido con un adorno de caballo en el capó.",
        description:
          "Al terminar la Segunda Guerra Mundial, miles de jeeps militares estadounidenses quedaron abandonados en Filipinas, y mecánicos locales los alargaron, les agregaron bancos laterales y los transformaron en los jeepneys, el medio de transporte público más emblemático del país, cubiertos hoy de pinturas brillantes, cromados, luces y adornos personalizados que convierten a cada unidad en una pieza única de arte popular rodante. Aunque en los últimos años el gobierno filipino impulsó un plan de modernización que reemplaza gradualmente estos vehículos artesanales por versiones más nuevas y estandarizadas por razones ambientales y de seguridad, el jeepney sigue siendo un símbolo tan reconocible de la identidad filipina que su silueta aparece en monumentos, souvenirs y hasta en el arte oficial del país.",
      },
      en: {
        title: "The Military Jeeps That Became Folk Art",
        subtitle: "Jeepneys, Folk Art on Wheels",
        imageAlt: "Cartoon of a stretched, colorful jeep with a horse ornament on the hood.",
        description:
          "When the Second World War ended, thousands of US military jeeps were left behind in the Philippines, and local mechanics stretched them, added side benches, and turned them into jeepneys, the country's most iconic form of public transport, today covered in bright paint jobs, chrome trim, lights, and custom ornaments that make every unit a unique piece of rolling folk art. Although in recent years the Philippine government pushed a modernization plan that's gradually replacing these handmade vehicles with newer, standardized versions for environmental and safety reasons, the jeepney remains such a recognizable symbol of Filipino identity that its silhouette shows up on monuments, souvenirs, and even official national art.",
      },
    },
  },
  {
    id: "la-temporada-navidena-mas-larga-del-mundo",
    order: 2,
    placeholderEmoji: "🎄",
    accentColor: "#C1272D",
    imageUrl: null,
    translations: {
      es: {
        title: "La temporada navideña más larga de todo el mundo",
        subtitle: "La temporada navideña más larga del mundo",
        imageAlt: "Caricatura de una farolita navideña filipina de estrella con puntas de papel.",
        description:
          "En Filipinas, país de mayoría católica más grande de Asia, la temporada navideña arranca oficialmente en septiembre, apenas comienzan los meses cuyo nombre en inglés termina en \"-ber\", y se extiende formalmente hasta comienzos de enero, convirtiéndola en una de las celebraciones navideñas más largas del planeta, con villancicos sonando en centros comerciales y misas especiales llamadas Simbang Gabi celebradas al amanecer durante nueve días consecutivos antes de Nochebuena. Un símbolo central de estas fiestas es el parol, una farolita artesanal en forma de estrella hecha tradicionalmente con bambú y papel de colores, colgada en las puertas de las casas como referencia a la estrella de Belén, y cuya fabricación artesanal se convirtió en una industria local propia, especialmente en la ciudad de San Fernando, autodenominada la capital navideña de Filipinas.",
      },
      en: {
        title: "The Longest Christmas Season Anywhere in the World",
        subtitle: "The World's Longest Christmas Season",
        imageAlt: "Cartoon of a Filipino star-shaped Christmas lantern with paper points.",
        description:
          "In the Philippines, Asia's largest Catholic-majority country, the Christmas season officially kicks off in September, as soon as the months whose English names end in \"-ber\" begin, and formally runs through early January, making it one of the longest Christmas celebrations on the planet, with carols playing in malls and special pre-dawn Masses called Simbang Gabi held for nine straight days before Christmas Eve. A central symbol of these festivities is the parol, a handmade star-shaped lantern traditionally built from bamboo and colored paper, hung on doorways as a nod to the Star of Bethlehem, whose crafting became a local industry of its own, especially in the city of San Fernando, which calls itself the Christmas Capital of the Philippines.",
      },
    },
  },
  {
    id: "las-colinas-de-chocolate-de-bohol",
    order: 3,
    placeholderEmoji: "⛰️",
    accentColor: "#8D6E63",
    imageUrl: null,
    translations: {
      es: {
        title: "Las mil colinas idénticas que se vuelven chocolate",
        subtitle: "Las Colinas de Chocolate de Bohol",
        imageAlt: "Caricatura de varias colinas cónicas idénticas en tono marrón.",
        description:
          "En la isla de Bohol se levantan más de 1.200 colinas de piedra caliza casi perfectamente cónicas y de altura similar, repartidas sobre un área de más de 50 kilómetros cuadrados en un paisaje tan geométricamente inusual que su origen geológico exacto todavía genera debate entre científicos, aunque la explicación más aceptada las atribuye a la erosión de antiguos depósitos de coral marino elevados con el tiempo sobre el nivel del mar. Durante la estación seca, el pasto verde que cubre las colinas se marchita y adquiere un tono marrón uniforme que le da su nombre popular a la formación, mientras que la tradición local ofrece una explicación mucho menos científica y más entrañable: una leyenda que atribuye las colinas a las lágrimas petrificadas de un gigante que lloró la muerte de la mujer que amaba.",
      },
      en: {
        title: "The Thousand Identical Hills That Turn Chocolate",
        subtitle: "Bohol's Chocolate Hills",
        imageAlt: "Cartoon of several identical cone-shaped hills in a brown tone.",
        description:
          "On the island of Bohol rise more than 1,200 almost perfectly cone-shaped limestone hills of similar height, spread across more than 50 square kilometers in a landscape so geometrically unusual that its exact geological origin is still debated among scientists, though the most accepted explanation attributes it to the erosion of ancient marine coral deposits gradually lifted above sea level. During the dry season, the green grass covering the hills withers into a uniform brown that gives the formation its popular name, while local tradition offers a far less scientific and much more endearing explanation: a legend attributing the hills to the petrified tears of a giant who wept over the death of the woman he loved.",
      },
    },
  },
  {
    id: "los-tarsiers-primates-diminutos-de-ojos-enormes",
    order: 4,
    placeholderEmoji: "🐒",
    accentColor: "#6D4C41",
    imageUrl: null,
    translations: {
      es: {
        title: "Los primates diminutos con los ojos más grandes",
        subtitle: "Los tarsiers, ojos enormes en un cuerpo diminuto",
        imageAlt: "Caricatura de un pequeño primate con ojos redondos y enormes.",
        description:
          "El tarsero filipino, un primate nocturno endémico de islas como Bohol y Samar que mide apenas entre diez y quince centímetros de largo, posee en proporción a su cuerpo los ojos más grandes de cualquier mamífero del planeta, cada uno más pesado que su propio cerebro, una adaptación extrema que le permite cazar insectos en total oscuridad girando la cabeza casi 180 grados hacia cualquier dirección sin mover el resto del cuerpo. La especie, extremadamente sensible al estrés y a la manipulación humana hasta el punto de poder autolesionarse gravemente en cautiverio inadecuado, hoy se protege en santuarios especializados de Bohol que promueven un turismo de observación silenciosa y a distancia, muy distinto del contacto directo que dañó a la población de tarseros en décadas anteriores.",
      },
      en: {
        title: "The Tiny Primate With the Biggest Eyes Around",
        subtitle: "Tarsiers, Huge Eyes on a Tiny Body",
        imageAlt: "Cartoon of a small primate with enormous round eyes.",
        description:
          "The Philippine tarsier, a nocturnal primate found only on islands like Bohol and Samar and measuring just ten to fifteen centimeters long, has, relative to its body, the largest eyes of any mammal on the planet, each one heavier than its own brain, an extreme adaptation letting it hunt insects in total darkness by turning its head nearly 180 degrees in any direction without moving the rest of its body. The species, extremely sensitive to stress and human handling to the point of being able to seriously self-injure under improper captivity, is now protected in specialized Bohol sanctuaries promoting quiet, distant observation tourism, very different from the direct handling that harmed tarsier populations in past decades.",
      },
    },
  },
  {
    id: "el-invento-filipino-detras-del-karaoke",
    order: 5,
    placeholderEmoji: "🎤",
    accentColor: "#8E24AA",
    imageUrl: null,
    translations: {
      es: {
        title: "El invento filipino que hizo posible el karaoke",
        subtitle: "El invento filipino detrás del karaoke",
        imageAlt: "Caricatura de un micrófono junto a una pantalla con letras de canción.",
        description:
          "Aunque la palabra karaoke tiene origen japonés, el ingeniero filipino Roberto del Rosario patentó en 1975 un dispositivo llamado Sing Along System, capaz de reproducir pistas instrumentales y mostrar letras de canciones sincronizadas para que cualquier persona pudiera cantar encima, una innovación técnica clave que ayudó a popularizar y perfeccionar el concepto tal como se conoce hoy en todo el mundo. Esa herencia inventiva se refleja en la enorme centralidad social del karaoke en la vida cotidiana filipina, presente en fiestas familiares, reuniones de vecinos y locales especializados por igual, hasta el punto de que cantar en público, bien o mal, se considera una actividad social absolutamente normal y esperada en prácticamente cualquier celebración del país.",
      },
      en: {
        title: "The Filipino Invention That Made Karaoke Possible",
        subtitle: "The Filipino Invention Behind Karaoke",
        imageAlt: "Cartoon of a microphone beside a screen showing song lyrics.",
        description:
          "Although the word karaoke has a Japanese origin, Filipino engineer Roberto del Rosario patented a device called the Sing Along System in 1975, capable of playing instrumental tracks and displaying synced song lyrics so anyone could sing along, a key technical innovation that helped popularize and refine the concept as it's known worldwide today. That inventive legacy shows up in how central karaoke is to everyday Filipino social life, present at family parties, neighborhood gatherings, and dedicated venues alike, to the point that singing in public, well or badly, is considered a perfectly normal and expected activity at practically any celebration in the country.",
      },
    },
  },
  {
    id: "jollibee-la-cadena-que-le-gana-a-mcdonalds",
    order: 6,
    placeholderEmoji: "🍗",
    accentColor: "#D32F2F",
    imageUrl: null,
    translations: {
      es: {
        title: "La cadena local que le gana a McDonald's en casa",
        subtitle: "Jollibee, la cadena que vence a McDonald's",
        imageAlt: "Caricatura de una hamburguesa junto a una porción de espagueti con salchicha.",
        description:
          "Jollibee, la cadena de comida rápida filipina fundada en 1978 a partir de una heladería familiar, se convirtió en la marca de comida rápida líder del país, superando en ventas locales a cadenas internacionales como McDonald's gracias a un menú adaptado al paladar filipino, con platos como espagueti dulce con salchicha y pollo frito jugoso servido con salsa gravy, muy distintos de la oferta estándar de las cadenas estadounidenses. La empresa expandió con fuerza su presencia internacional siguiendo a la enorme diáspora filipina repartida por el mundo, y hoy sus locales fuera del país suelen generar largas filas de clientes nostálgicos, convirtiendo a la abeja sonriente de su logo en un símbolo de identidad nacional casi tan reconocible como cualquier otro ícono cultural filipino.",
      },
      en: {
        title: "The Local Chain That Beats McDonald's at Home",
        subtitle: "Jollibee, the Chain That Beats McDonald's",
        imageAlt: "Cartoon of a burger beside a plate of spaghetti with sliced sausage.",
        description:
          "Jollibee, the Filipino fast-food chain founded in 1978 out of a family ice cream parlor, became the country's leading fast-food brand, outselling international chains like McDonald's locally thanks to a menu adapted to Filipino taste, with dishes like sweet spaghetti topped with sliced hot dog and juicy fried chicken served with gravy, quite different from the standard offerings of American chains. The company expanded aggressively abroad by following the massive Filipino diaspora spread across the world, and today its overseas locations often draw long lines of homesick customers, turning its smiling bee logo into a symbol of national identity almost as recognizable as any other Filipino cultural icon.",
      },
    },
  },
  {
    id: "la-bahay-kubo-una-casa-pensada-para-el-tropico",
    order: 7,
    placeholderEmoji: "🏠",
    accentColor: "#558B2F",
    imageUrl: null,
    translations: {
      es: {
        title: "La casa de bambú elevada pensada para el trópico",
        subtitle: "La bahay kubo, una casa hecha para el trópico",
        imageAlt: "Caricatura de una casa elevada sobre postes con techo de paja triangular.",
        description:
          "La bahay kubo, la vivienda tradicional filipina construida con bambú, madera liviana y techo de paja de nipa, se eleva sobre postes a poca altura del suelo, un diseño pensado para protegerse de inundaciones estacionales, mantener el interior fresco en el calor tropical mediante pisos con rendijas que permiten circular el aire, y facilitar el acceso rápido a un espacio de almacenamiento o cría de animales debajo de la vivienda. El diseño, tan arraigado en la identidad nacional que le da nombre a una canción folclórica infantil conocida por generaciones enteras de filipinos, sigue construyéndose y habitándose hoy en muchas zonas rurales del archipiélago, valorado por su bajo costo, materiales locales renovables y una adaptación climática que ninguna vivienda de estilo occidental logró igualar del todo en el contexto tropical filipino.",
      },
      en: {
        title: "The Elevated Bamboo House Built for the Tropics",
        subtitle: "The Bahay Kubo, Built for the Tropics",
        imageAlt: "Cartoon of a house raised on stilts with a triangular thatched roof.",
        description:
          "The bahay kubo, the traditional Filipino dwelling built from bamboo, light wood, and a nipa-thatch roof, is raised on low stilts above the ground, a design meant to guard against seasonal flooding, keep the interior cool in tropical heat through slatted floors that let air circulate, and allow quick access to storage or animal space underneath the home. The design, so deeply woven into national identity that it lends its name to a children's folk song known by entire generations of Filipinos, is still built and lived in today across many rural parts of the archipelago, valued for its low cost, renewable local materials, and a climate adaptation that no Western-style home ever fully matched in the Filipino tropical context.",
      },
    },
  },
  {
    id: "las-terrazas-de-arroz-la-octava-maravilla",
    order: 8,
    placeholderEmoji: "🌾",
    accentColor: "#2E7D32",
    imageUrl: null,
    translations: {
      es: {
        title: "Las terrazas de arroz llamadas octava maravilla",
        subtitle: "Las Terrazas de Arroz de Banaue",
        imageAlt: "Caricatura de terrazas de cultivo escalonadas trepando una ladera.",
        description:
          "Las Terrazas de Arroz de Banaue, talladas a mano por el pueblo ifugao en las montañas de la isla de Luzón hace unos 2.000 años sin herramientas metálicas ni maquinaria alguna, se conocen popularmente como la octava maravilla del mundo, y si se extendieran todos sus muros de contención en línea recta alcanzarían una longitud suficiente para dar la vuelta a más de la mitad de la circunferencia del planeta. El sistema, que sigue en uso agrícola activo y depende de un ingenioso manejo comunitario de canales de riego alimentados por los bosques de las cumbres cercanas, fue declarado Patrimonio de la Humanidad por la UNESCO, aunque en años recientes enfrenta un desafío creciente: la migración de jóvenes ifugao hacia las ciudades dejó a muchas terrazas sin suficiente mano de obra para su mantenimiento tradicional.",
      },
      en: {
        title: "The Rice Terraces Called the Eighth Wonder",
        subtitle: "The Banaue Rice Terraces",
        imageAlt: "Cartoon of stepped farming terraces climbing a hillside.",
        description:
          "The Banaue Rice Terraces, hand-carved by the Ifugao people into the mountains of Luzon island roughly 2,000 years ago with no metal tools or machinery at all, are popularly known as the eighth wonder of the world, and if all their retaining walls were laid end to end they would stretch far enough to circle more than half the planet's circumference. The system, still in active agricultural use and dependent on ingenious community management of irrigation channels fed by the forests on nearby peaks, was declared a UNESCO World Heritage Site, though in recent years it faces a growing challenge: young Ifugao migrating to cities has left many terraces without enough labor for their traditional upkeep.",
      },
    },
  },
  {
    id: "sinulog-tambores-catolicos-e-indigenas-juntos",
    order: 9,
    placeholderEmoji: "🥁",
    accentColor: "#F57C00",
    imageUrl: null,
    translations: {
      es: {
        title: "El festival que mezcla tambores nativos y fe católica",
        subtitle: "El Sinulog, tambores indígenas y fe católica",
        imageAlt: "Caricatura de un tambor decorado junto a una vela encendida.",
        description:
          "El Sinulog, celebrado cada enero en la ciudad de Cebú en honor al Santo Niño, combina un paso de baile ritual prehispánico, dos pasos hacia adelante y uno hacia atrás al ritmo de tambores nativos, con la devoción católica traída por los colonizadores españoles, en una de las fusiones religiosas y culturales más vistosas de todo el país, con procesiones que reúnen a millones de participantes vestidos con trajes tribales de colores intensos junto a imágenes religiosas centenarias. El festival, que comparte raíces similares con otras celebraciones filipinas como el Ati-Atihan de Kalibo, es considerado por historiadores un ejemplo particularmente claro de cómo la religiosidad popular filipina absorbió e integró prácticas espirituales indígenas preexistentes en lugar de simplemente reemplazarlas por completo.",
      },
      en: {
        title: "The Festival Blending Native Drums and Catholic Faith",
        subtitle: "Sinulog, Native Drums and Catholic Faith",
        imageAlt: "Cartoon of a decorated drum beside a lit candle.",
        description:
          "Sinulog, held every January in Cebu City in honor of the Santo Niño, blends a pre-Hispanic ritual dance step, two steps forward and one back to the beat of native drums, with the Catholic devotion brought by Spanish colonizers, in one of the most vivid religious and cultural fusions in the entire country, with processions drawing millions of participants dressed in vividly colored tribal costumes alongside centuries-old religious images. The festival, which shares similar roots with other Filipino celebrations like Kalibo's Ati-Atihan, is considered by historians a particularly clear example of how Filipino popular religiosity absorbed and folded in preexisting indigenous spiritual practices rather than simply replacing them outright.",
      },
    },
  },
  {
    id: "el-rio-subterraneo-navegable-mas-largo",
    order: 10,
    placeholderEmoji: "🕳️",
    accentColor: "#00838F",
    imageUrl: null,
    translations: {
      es: {
        title: "El río subterráneo navegable más largo del mundo",
        subtitle: "El río subterráneo de Puerto Princesa",
        imageAlt: "Caricatura de una barca navegando dentro de una cueva iluminada.",
        description:
          "El Río Subterráneo de Puerto Princesa, en la isla de Palawan, recorre más de ocho kilómetros bajo un sistema de cuevas de piedra caliza antes de desembocar directamente en el mar, lo que lo convierte en uno de los ríos subterráneos navegables más largos del planeta y en una de las Nuevas Siete Maravillas de la Naturaleza elegidas por votación pública internacional. El recorrido en barca, permitido solo en un tramo inicial por motivos de seguridad y conservación, atraviesa cavernas decoradas con formaciones de estalactitas y estalagmitas que tardaron miles de años en formarse, además de albergar colonias de murciélagos y una biodiversidad marina y de agua dulce excepcional en el punto exacto donde el ecosistema subterráneo se encuentra con el océano abierto.",
      },
      en: {
        title: "The World's Longest Navigable Underground River",
        subtitle: "The Puerto Princesa Underground River",
        imageAlt: "Cartoon of a small boat gliding through a lit cave.",
        description:
          "The Puerto Princesa Underground River, on Palawan island, runs more than eight kilometers through a system of limestone caves before flowing directly into the sea, making it one of the longest navigable underground rivers on the planet and one of the New7Wonders of Nature chosen by international public vote. The boat tour, permitted only along an initial stretch for safety and conservation reasons, passes through caverns decorated with stalactite and stalagmite formations that took thousands of years to form, and it's also home to bat colonies and an exceptional mix of marine and freshwater biodiversity right at the point where the underground ecosystem meets the open ocean.",
      },
    },
  },
  {

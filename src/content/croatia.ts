...
export const croatia: CultureEntry[] = [
  {
    id: "corbata",
    order: 1,
    placeholderEmoji: "👔",
    ...
    translations: {
      es: {
        title: "La corbata nació acá",
        subtitle: "La corbata (kravata)",
        imageAlt:
          "Caricatura de un mercenario croata del siglo XVII con un pañuelo anudado al cuello, precursor de la corbata.",
        description:
          "La corbata, tal como la conocemos hoy, tiene su origen en los mercenarios croatas que servían en el ejército francés durante el siglo XVII: llevaban un pañuelo anudado al cuello como parte de su uniforme, que llamó la atención de la corte de Luis XIV y se puso de moda rápidamente en París bajo el nombre de 'cravate' —una deformación de 'Croate', croata en francés—. Croacia celebra esta herencia cada 18 de octubre con el Día de la Corbata, y en Zagreb hay incluso un monumento gigante en forma de corbata en la plaza central. Pocos objetos cotidianos tienen un origen nacional tan bien documentado y, a la vez, tan poco conocido fuera del país.",
      },
      en: {
        title: "The Necktie Was Born Here",
        subtitle: "The Necktie (Kravata)",
        imageAlt:
          "Cartoon of a 17th-century Croatian mercenary with a knotted scarf around his neck, the precursor to the necktie.",
        description:
          "The necktie, as we know it today, originated with Croatian mercenaries serving in the French army during the 17th century: they wore a knotted scarf around their neck as part of their uniform, which caught the attention of Louis XIV's court and quickly became fashionable in Paris under the name 'cravate' — a distortion of 'Croate,' Croatian in French. Croatia celebrates this legacy every October 18th with Necktie Day, and Zagreb even has a giant necktie-shaped monument in its central square. Few everyday objects have such a well-documented national origin that's also so little known outside the country.",
      },
    },
  },
  {
    ...
    translations: {
      es: {
        title: "Más de mil islas para elegir",
        subtitle: "El Adriático",
        imageAlt:
          "Caricatura de un velero navegando entre islas croatas de aguas turquesas y pueblos de piedra.",
        description:
          "Croacia tiene más de 1.200 islas, islotes y arrecifes a lo largo de su costa adriática, aunque solo unas 50 están habitadas de forma permanente. Islas como Hvar, Brač o Vis combinan aguas de un color turquesa casi irreal con pueblos de piedra que cambiaron poco en siglos, y se volvieron destinos de moda internacional en la última década. La costa, declarada en varios tramos Patrimonio de la Humanidad, se recorre tradicionalmente en barco, saltando de isla en isla, una forma de viajar tan arraigada que muchos croatas la consideran una parte esencial de sus propias vacaciones de verano, no solo una atracción turística.",
      },
      en: {
        title: "Over a Thousand Islands to Choose From",
        subtitle: "The Adriatic",
        imageAlt:
          "Cartoon of a sailboat navigating between Croatian islands with turquoise water and stone villages.",
        description:
          "Croatia has more than 1,200 islands, islets, and reefs along its Adriatic coast, though only about 50 are permanently inhabited. Islands like Hvar, Brač, or Vis combine almost impossibly turquoise waters with stone villages that have changed little over the centuries, and have become fashionable international destinations over the last decade. The coastline, designated a World Heritage Site in several stretches, is traditionally explored by boat, island-hopping — a way of traveling so ingrained that many Croatians consider it an essential part of their own summer vacations, not just a tourist attraction.",
      },
    },
  },
  {
    ...
    translations: {
      es: {
        title: "La ciudad que se volvió Desembarco del Rey",
        subtitle: "Dubrovnik",
        imageAlt:
          "Caricatura de las murallas medievales de Dubrovnik rodeando la ciudad vieja junto al mar Adriático.",
        description:
          "Dubrovnik, con sus murallas medievales casi intactas rodeando la ciudad vieja, es Patrimonio de la Humanidad desde 1979 y una de las ciudades amuralladas mejor conservadas de Europa. Su fama se disparó a nivel global cuando se convirtió en la locación principal de Desembarco del Rey en la serie Juego de Tronos, lo que multiplicó el turismo de forma tan intensa que la ciudad tuvo que empezar a limitar la cantidad de visitantes y cruceros que pueden entrar por día para proteger tanto el patrimonio como la calidad de vida de sus habitantes. Recorrer sus murallas completas, con vista al mar Adriático de un lado y a los techos de tejas rojas del otro, lleva cerca de dos horas.",
      },
      en: {
        title: "The City That Became King's Landing",
        subtitle: "Dubrovnik",
        imageAlt:
          "Cartoon of Dubrovnik's medieval walls encircling the old town beside the Adriatic Sea.",
        description:
          "Dubrovnik, with its nearly intact medieval walls encircling the old town, has been a World Heritage Site since 1979 and is one of the best-preserved walled cities in Europe. Its global fame skyrocketed when it became the main filming location for King's Landing in Game of Thrones, which drove tourism up so sharply that the city had to start limiting how many visitors and cruise ships could enter per day, to protect both its heritage and its residents' quality of life. Walking the full length of its walls, with the Adriatic Sea on one side and red-tiled rooftops on the other, takes about two hours.",
      },
    },
  },
  {
    ...
    translations: {
      es: {
        title: "Los Vatreni, gigantes de a poco",
        subtitle: "Fútbol croata",
        imageAlt:
          "Caricatura de un jugador de fútbol croata con la camiseta a cuadros rojos y blancos levantando los brazos.",
        description:
          "Con apenas unos 3,8 millones de habitantes, Croacia es uno de los países más pequeños en alcanzar una final de Copa del Mundo, algo que logró en 2018 frente a Francia. Cuatro años después, en Qatar 2022, volvió a quedar entre los cuatro mejores del torneo. La selección, apodada 'Vatreni' (los ardientes) por su clásica camiseta a cuadros rojos y blancos, cuenta con jugadores como Luka Modrić, considerado uno de los mejores mediocampistas de su generación pese al tamaño reducido de su país de origen. Cuando la selección vuelve de un gran torneo, cientos de miles de personas —una porción enorme de la población total— salen a recibirlos en las calles de Zagreb.",
      },
      en: {
        title: "The Vatreni, Giants in Small Packages",
        subtitle: "Croatian Football",
        imageAlt:
          "Cartoon of a Croatian football player in the red-and-white checkered jersey, arms raised.",
        description:
          "With barely 3.8 million people, Croatia is one of the smallest countries ever to reach a World Cup final, which it did in 2018 against France. Four years later, at Qatar 2022, it reached the semifinals again. The national team, nicknamed 'Vatreni' (the fiery ones) for its classic red-and-white checkered jersey, features players like Luka Modrić, considered one of the best midfielders of his generation despite his country's small size. When the team returns from a major tournament, hundreds of thousands of people — a huge share of the total population — pour into the streets of Zagreb to welcome them home.",
      },
    },
  },
  {
    ...
    translations: {
      es: {
        title: "Cantar a capela junto al mar",
        subtitle: "Klapa",
        imageAlt:
          "Caricatura de un grupo de hombres cantando klapa a capela en una plaza junto al mar.",
        description:
          "La klapa es un estilo de canto a capela tradicional de la región de Dalmacia, interpretado por grupos de hombres o mujeres que cantan a varias voces sin ningún instrumento, con armonías que se aprenden de oído y se transmiten de generación en generación. Sus letras hablan típicamente del mar, el amor, el vino y la vida en los pueblos costeros, y es habitual escuchar un grupo de klapa cantando espontáneamente en una plaza o una taberna después de la cena. Reconocida por la UNESCO como Patrimonio Cultural Inmaterial en 2012, la klapa sigue viva no solo en festivales formales sino en la vida cotidiana de la costa dálmata.",
      },
      en: {
        title: "Singing A Cappella by the Sea",
        subtitle: "Klapa",
        imageAlt:
          "Cartoon of a group of men singing klapa a cappella in a square by the sea.",
        description:
          "Klapa is a traditional a cappella singing style from the Dalmatia region, performed by groups of men or women singing in multiple harmonized voices with no instruments at all, learned by ear and passed down from generation to generation. Its lyrics typically speak of the sea, love, wine, and life in coastal villages, and it's common to hear a klapa group singing spontaneously in a square or a tavern after dinner. Recognized by UNESCO as Intangible Cultural Heritage in 2012, klapa stays alive not just in formal festivals but in the everyday life of the Dalmatian coast.",
      },
    },
  },
  {
    ...
    translations: {
      es: {
        title: "Una ciudad adentro de un palacio romano",
        subtitle: "El Palacio de Diocleciano",
        imageAlt:
          "Caricatura de las columnas romanas del Palacio de Diocleciano con negocios modernos funcionando entre ellas.",
        description:
          "El emperador romano Diocleciano se construyó un enorme palacio de retiro en la costa de la actual Split alrededor del año 300 d.C., y en vez de convertirse en ruina, terminó absorbido por la ciudad: durante siglos la gente construyó sus casas, tiendas y calles directamente dentro y sobre las murallas del palacio, y hoy buena parte del centro histórico de Split literalmente funciona dentro de la estructura romana original. Es uno de los pocos lugares del mundo donde se puede tomar un café o comprar ropa en un local que ocupa lo que hace 1.700 años era la habitación de un emperador. La UNESCO lo declaró Patrimonio de la Humanidad en 1979.",
      },
      en: {
        title: "A City Inside a Roman Palace",
        subtitle: "Diocletian's Palace",
        imageAlt:
          "Cartoon of the Roman columns of Diocletian's Palace with modern shops operating among them.",
        description:
          "The Roman emperor Diocletian built himself a massive retirement palace on the coast of what is now Split around 300 CE, and instead of falling into ruin, it ended up absorbed by the city: for centuries, people built their homes, shops, and streets directly inside and on top of the palace walls, and today much of Split's historic center literally operates within the original Roman structure. It's one of the few places in the world where you can grab a coffee or buy clothes in a shop that occupies what, 1,700 years ago, was an emperor's private quarters. UNESCO declared it a World Heritage Site in 1979.",
      },
    },
  },
  {
    ...
    translations: {
      es: {
        title: "Un trago para cada ocasión",
        subtitle: "Rakija",
        imageAlt:
          "Caricatura de una botella casera de rakija y pequeños vasos sobre una mesa de madera rústica.",
        description:
          "La rakija es un aguardiente de frutas —de uva, ciruela, manzana o hierbas, entre otras variedades— que se destila de forma casera en gran parte de Croacia, muchas veces con recetas familiares que pasan de generación en generación. Es habitual que se ofrezca como bienvenida al llegar a una casa, como brindis antes de una comida, o incluso como remedio casero informal para un resfrío. Muchas familias rurales todavía tienen su propio alambique y compiten, de forma amistosa, por tener la mejor rakija del pueblo. Rechazar una copa ofrecida como bienvenida se puede interpretar, en algunos contextos, como una descortesía.",
      },
      en: {
        title: "A Drink for Every Occasion",
        subtitle: "Rakija",
        imageAlt:
          "Cartoon of a homemade bottle of rakija and small glasses on a rustic wooden table.",
        description:
          "Rakija is a fruit brandy — made from grapes, plums, apples, or herbs, among other varieties — distilled at home across much of Croatia, often following family recipes passed down through generations. It's commonly offered as a welcome when arriving at someone's house, as a toast before a meal, or even as an informal home remedy for a cold. Many rural families still have their own still and compete, in a friendly way, over who makes the best rakija in the village. Turning down a glass offered as a welcome can, in some settings, be read as impolite.",
      },
    },
  },
  {
    ...
    translations: {
      es: {
        title: "Dieciséis lagos en cascada",
        subtitle: "Lagos de Plitvice",
        imageAlt:
          "Caricatura de pasarelas de madera cruzando los lagos turquesa y cascadas del parque de Plitvice.",
        description:
          "El Parque Nacional de los Lagos de Plitvice tiene 16 lagos escalonados conectados por cascadas, con un color de agua que va del turquesa al verde esmeralda según la luz y los minerales disueltos. Es el parque nacional más antiguo del sudeste de Europa, protegido desde 1949, y Patrimonio de la Humanidad por la UNESCO desde 1979. Pasarelas de madera construidas sobre el agua permiten recorrer el parque caminando literalmente sobre y entre los lagos, rodeado de bosque, sin necesidad de barcos ni vehículos motorizados, que están prohibidos dentro del área protegida para preservar su ecosistema casi intacto.",
      },
      en: {
        title: "Sixteen Cascading Lakes",
        subtitle: "Plitvice Lakes",
        imageAlt:
          "Cartoon of wooden boardwalks crossing the turquoise lakes and waterfalls of Plitvice park.",
        description:
          "Plitvice Lakes National Park has 16 terraced lakes connected by waterfalls, with water color ranging from turquoise to emerald green depending on the light and dissolved minerals. It's the oldest national park in Southeast Europe, protected since 1949, and a UNESCO World Heritage Site since 1979. Wooden boardwalks built over the water let visitors walk literally over and between the lakes, surrounded by forest, with no need for boats or motorized vehicles, which are banned within the protected area to preserve its nearly untouched ecosystem.",
      },
    },
  },
  {
    ...
    translations: {
      es: {
        title: "El tesoro escondido bajo los robles",
        subtitle: "La trufa de Istria",
        imageAlt:
          "Caricatura de un cazador de trufas con un perro entrenado buscando en el bosque de Motovun.",
        description:
          "El bosque de Motovun, en la península de Istria, es uno de los pocos lugares del mundo donde crecen de forma natural tanto la trufa blanca como la negra, buscadas con perros entrenados por generaciones de familias truferas locales. En 1999 se encontró ahí una trufa blanca de más de 1,3 kilos, registrada como una de las más grandes jamás halladas, un hito que puso a la región en el mapa gastronómico mundial. Hoy Istria combina esta tradición trufera con una escena culinaria en pleno auge, y pueblos como Livade organizan festivales enteros dedicados al hongo, con menús donde la trufa aparece desde la pasta hasta el helado.",
      },
      en: {
        title: "The Hidden Treasure Beneath the Oaks",
        subtitle: "Istrian Truffles",
        imageAlt:
          "Cartoon of a truffle hunter with a trained dog searching the Motovun forest.",
        description:
          "The Motovun forest, on the Istrian peninsula, is one of the few places in the world where both white and black truffles grow naturally, hunted with dogs trained across generations of local truffle-hunting families. In 1999, a white truffle weighing over 1.3 kilos was found there, recorded as one of the largest ever discovered, a milestone that put the region on the global culinary map. Today Istria combines this truffle tradition with a booming food scene, and villages like Livade host entire festivals dedicated to the fungus, with menus featuring truffle in everything from pasta to ice cream.",
      },
    },
  },
  {
    ...
    translations: {
      es: {
        title: "Corazones de miel que no se comen",
        subtitle: "Licitar srca",
        imageAlt:
          "Caricatura de galletas de miel en forma de corazón, decoradas de rojo, colgando como adorno.",
        description:
          "Los 'licitar srca' son galletas artesanales en forma de corazón, hechas con una masa de miel endulzada y decoradas a mano con glasé de azúcar en colores vivos, tradicionalmente rojo. Se elaboran en el norte de Croacia desde el siglo XVI, originalmente por gremios de panaderos, y aunque parecen golosinas, hoy en día casi nunca se comen: se regalan como símbolo de cariño, sobre todo en fiestas populares y como recuerdo de Zagreb, y muchas familias los cuelgan como adorno en su casa durante años. La UNESCO los reconoció como Patrimonio Cultural Inmaterial en 2010, y siguen siendo, junto a la corbata, uno de los símbolos artesanales más queridos del país.",
      },
      en: {
        title: "Honey Hearts You're Not Meant to Eat",
        subtitle: "Licitar Hearts",
        imageAlt:
          "Cartoon of heart-shaped honey cookies, decorated in red, hanging as ornaments.",
        description:
          "'Licitar srca' are handcrafted heart-shaped cookies made from sweetened honey dough and decorated by hand with brightly colored icing, traditionally red. They've been made in northern Croatia since the 16th century, originally by baking guilds, and although they look like candy, they're almost never eaten today: they're given as a token of affection, especially at folk festivals and as a souvenir from Zagreb, and many families hang them as decorations in their homes for years. UNESCO recognized them as Intangible Cultural Heritage in 2010, and along with the necktie, they remain one of the country's most beloved handmade symbols.",
      },
    },
  },
  {

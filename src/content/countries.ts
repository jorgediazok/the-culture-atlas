...
export const countries: Country[] = [
  {
    ...
    translations: {
      es: {
        name: "Países Bajos",
        intro:
          "Un país que le ganó tierra al mar y construyó su identidad entera alrededor de eso: bicicletas antes que autos, canales antes que autopistas, y una franqueza que sorprende a cualquiera que llega de afuera. Estas páginas son para empezar a entender por qué los Países Bajos no se parecen a ningún otro lugar de Europa.",
        capital: "Ámsterdam",
        language: "Neerlandés",
        currency: "Euro (€)",
      },
      en: {
        name: "Netherlands",
        intro:
          "A country that won its own land back from the sea and built its entire identity around that idea: bicycles before cars, canals before highways, and a bluntness that catches every outsider off guard. These pages are here to start understanding why the Netherlands doesn't look like anywhere else in Europe.",
        capital: "Amsterdam",
        language: "Dutch",
        currency: "Euro (€)",
      },
  ...
  },
  {
    ...
    translations: {
      es: {
        name: "Argentina",
        intro:
          "Un país que se define tanto por lo que discute como por lo que comparte: el mate que pasa de mano en mano, el asado de los domingos, el fútbol como religión y una forma de hablar inconfundible en cualquier parte del mundo. Estas páginas son para conocer la Argentina más allá de los clichés.",
      ...
      en: {
        name: "Argentina",
        intro:
          "A country defined as much by what it argues about as by what it shares: mate passed hand to hand, Sunday asado, football as religion, and a way of speaking instantly recognizable anywhere in the world. These pages are here to get to know Argentina beyond the clichés.",
        capital: "Buenos Aires",
        language: "Spanish",
  ...
  },
  {
    ...
    translations: {
      es: {
        name: "Bélgica",
        intro:
          "Un país chico, partido en tres idiomas, que terminó exportando algunas de las cosas más queridas del planeta: chocolate, cerveza, papas fritas y los cómics que se leen en cualquier idioma. Estas páginas son para descubrir todo lo que Bélgica le dio al mundo sin hacer mucho ruido.",
        capital: "Bruselas",
        language: "Neerlandés, francés y alemán",
        currency: "Euro (€)",
      },
      en: {
        name: "Belgium",
        intro:
          "A small country, split across three languages, that ended up exporting some of the most beloved things on the planet: chocolate, beer, fries, and comics read in every language. These pages are here to discover everything Belgium gave the world without making much noise about it.",
        capital: "Brussels",
  ...
  },
  {
    ...
    translations: {
      es: {
        name: "Suiza",
        intro:
          "Precisión, neutralidad y montañas: Suiza construyó una reputación de perfección que se nota en sus relojes, sus trenes y hasta en cómo vota. Estas páginas son para entender un país que parece funcionar con una lógica propia, distinta a la de cualquier otro.",
        capital: "Berna",
        language: "Alemán, francés, italiano y romanche",
        currency: "Franco suizo (CHF)",
      },
      en: {
        name: "Switzerland",
        intro:
          "Precision, neutrality, and mountains: Switzerland built a reputation for perfection that shows up in its watches, its trains, and even how it votes. These pages are here to understand a country that seems to run on its own logic, unlike anywhere else.",
        capital: "Bern",
  ...
  },
  {
    ...
    translations: {
      es: {
        name: "Francia",
        intro:
          "El país que inventó buena parte de lo que hoy llamamos 'buen vivir': el pan de todos los días, el vino compartido, el cine como arte y una idea muy clara de que el tiempo libre no se negocia. Estas páginas son para recorrer Francia más allá de la Torre Eiffel.",
        capital: "París",
        language: "Francés",
        currency: "Euro (€)",
      },
      en: {
        name: "France",
        intro:
          "The country that invented much of what we now call 'living well': daily bread, wine shared at the table, cinema as art, and a very clear idea that free time is non-negotiable. These pages are here to explore France beyond the Eiffel Tower.",
        capital: "Paris",
        language: "French",
        currency: "Euro (€)",
      },
  ...
  },
  {
    ...
    translations: {
      es: {
        name: "Croacia",
        intro:
          "Mil islas, una costa que compite con cualquiera del Mediterráneo, y un país que —sin que casi nadie lo sepa— inventó un accesorio que hoy usa medio mundo. Estas páginas son para descubrir Croacia más allá del verano en el Adriático.",
        capital: "Zagreb",
        language: "Croata",
        currency: "Euro (€)",
      },
      en: {
        name: "Croatia",
        intro:
          "A thousand islands, a coastline that rivals anywhere in the Mediterranean, and a country that — almost unknowingly — invented an accessory half the world now wears. These pages are here to discover Croatia beyond the Adriatic summer.",
        capital: "Zagreb",
        language: "Croatian",
        currency: "Euro (€)",
      },
  ...
  },
  {
    ...
    translations: {
      es: {
        name: "Luxemburgo",
        intro:
          "Uno de los países más chicos de Europa y, a la vez, uno de los más ricos, con castillos por todos lados y la firma de un tratado que cambió cómo se viaja en todo el continente. Estas páginas son para conocer un país que la mayoría solo ve de paso.",
        capital: "Luxemburgo",
        language: "Luxemburgués, francés y alemán",
        currency: "Euro (€)",
      },
      en: {
        name: "Luxembourg",
        intro:
          "One of Europe's smallest countries and, at the same time, one of its richest, dotted with castles and home to a treaty signing that changed how the whole continent travels. These pages are here to get to know a country most people only ever pass through.",
  ...
  },
  {
    ...
    translations: {
      es: {
        name: "Albania",
        intro:
          "Un país que pasó de la paranoia y el aislamiento total a convertirse en uno de los últimos secretos bien guardados del Mediterráneo. Estas páginas son de historia, montañas, costa y una palabra —besa— que dice más sobre su gente que cualquier otra cosa.",
        capital: "Tirana",
        language: "Albanés",
      ...
      en: {
        name: "Albania",
        intro:
          "A country that went from total paranoia and isolation to becoming one of the Mediterranean's last well-kept secrets. These pages are about history, mountains, coastline, and a single word — besa — that says more about its people than anything else.",
        capital: "Tirana",
        language: "Albanian",
  ...
  },
  {
    ...
    translations: {
      es: {
        name: "Italia",
        intro:
          "Pasta, café, autos y cine: pocos países exportaron tanta cultura cotidiana como Italia, un lugar donde hasta la forma de tomar un café tiene sus propias reglas no escritas. Estas páginas son para entender por qué el resto del mundo sigue tratando de copiarle el estilo.",
        capital: "Roma",
        language: "Italiano",
        currency: "Euro (€)",
      },
      en: {
        name: "Italy",
        intro:
          "Pasta, coffee, cars, and cinema: few countries have exported as much everyday culture as Italy, a place where even how you drink your coffee has its own unwritten rules. These pages are here to understand why the rest of the world keeps trying to copy its style.",
        capital: "Rome",
        language: "Italian",
        currency: "Euro (€)",
      },
  ...
  },
  {
    ...
    translations: {
      es: {
        name: "Rusia",
        intro:
          "El país más grande del planeta, con un tren que tarda una semana en cruzarlo de punta a punta, una tradición literaria que se mide en cientos de páginas, y una forma de recibir invitados que no se parece a ninguna otra. Estas páginas son para asomarse a Rusia más allá de los titulares.",
        capital: "Moscú",
        language: "Ruso",
      ...
      en: {
        name: "Russia",
        intro:
          "The largest country on the planet, home to a train ride that takes a week to cross end to end, a literary tradition measured in hundreds of pages, and a way of welcoming guests unlike anywhere else. These pages are here to look at Russia beyond the headlines.",
        capital: "Moscow",
        language: "Russian",
  ...
  },
  {
    ...
    translations: {
      es: {
        name: "Brasil",
        intro:
          "El país más grande de Sudamérica, donde el fútbol se juega descalzo en la playa, el Carnaval detiene todo por una semana y la selva más grande del planeta ocupa la mitad del territorio. Estas páginas son para descubrir un Brasil que va mucho más allá del samba y el fútbol.",
        capital: "Brasilia",
        language: "Portugués",
      ...
      en: {
        name: "Brazil",
        intro:
          "South America's largest country, where football is played barefoot on the beach, Carnival brings everything to a halt for a week, and the planet's biggest rainforest covers half the territory. These pages are here to discover a Brazil that goes far beyond samba and football.",
        capital: "Brasília",
        language: "Portuguese",
  ...
  },
  {
    ...
    translations: {
      es: {
        name: "Colombia",
        intro:
          "Un país de cafetales, esmeraldas y una biodiversidad que no tiene rival, donde el realismo mágico de García Márquez no parece tan lejos de la realidad cotidiana. Estas páginas son para conocer una Colombia mucho más grande que sus titulares.",
        capital: "Bogotá",
        language: "Español",
      ...
      en: {
        name: "Colombia",
        intro:
          "A country of coffee farms, emeralds, and unrivaled biodiversity, where García Márquez's magical realism never feels too far from everyday life. These pages are here to get to know a Colombia far bigger than its headlines.",
        capital: "Bogotá",
        language: "Spanish",
  ...
  },
  {
    ...
    translations: {
      es: {
        name: "Cabo Verde",
        intro:
          "Diez islas volcánicas en medio del Atlántico, unidas por la morna, el criollo y una diáspora más grande que el propio país. Estas páginas son para conocer un archipiélago pequeño con una identidad cultural enorme.",
        capital: "Praia",
        language: "Portugués",
      ...
      en: {
        name: "Cape Verde",
        intro:
          "Ten volcanic islands in the middle of the Atlantic, tied together by morna, Creole, and a diaspora larger than the country itself. These pages are here to get to know a small archipelago with an enormous cultural identity.",
        capital: "Praia",
        language: "Portuguese",
  ...
  },
  {
    ...
    translations: {
      es: {
        ...
        capital: "Sarajevo",
        language: "Bosnio, croata y serbio",
  ...
  },
  {
    ...
    translations: {
      es: {
        ...
        capital: "Edimburgo",
        language: "Inglés y gaélico escocés",
        currency: "Libra esterlina (GBP)",
      },
      en: {
        name: "Scotland",
  ...
  },
  {
    ...
    translations: {
      es: {
        ...
        language: "Cingalés y tamil",
        currency: "Rupia esrilanquesa (LKR)",
      },
      en: {
        name: "Sri Lanka",
        intro:
  ...
  },
  {
    ...
    translations: {
      es: {
        ...
        capital: "Singapur",
        language: "Inglés, malayo, mandarín y tamil",
  ...
  },
  {
    ...
    translations: {
      es: {
        ...
        capital: "Taipéi",
        language: "Chino mandarín",
        currency: "Nuevo dólar taiwanés (TWD)",
      },
      en: {
        name: "Taiwan",
        intro:
  ...
  },
  {
    ...
    translations: {
      es: {
        ...
        capital: "Bridgetown",
        language: "Inglés",
        currency: "Dólar de Barbados (BBD)",
      },
      en: {
        name: "Barbados",
        intro:
  ...
  },
  {
    ...
    translations: {
      es: {
        ...
        capital: "Mbabane",
        language: "Suazi e inglés",
        currency: "Lilangeni suazi (SZL)",
      },
      en: {
        name: "Eswatini",
        intro:
  ...
  },
  {
    ...
    translations: {
      es: {
        ...
        capital: "Moroni",
        language: "Shikomori, árabe y francés",
        currency: "Franco comorano (KMF)",
      },
      en: {
        name: "Comoros",
        intro:
        ...
        capital: "Moroni",
        language: "Shikomori, Arabic, and French",
